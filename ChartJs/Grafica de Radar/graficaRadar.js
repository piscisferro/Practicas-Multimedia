...
function iniciar() { 
    ...
    // Datos de la grafica
    var radarChart = {
        labels: ["Elem1", "Elem2", "Elem3", "Elem4", "Elem5", "elem6"], // Elementos (eje X)
            datasets: [{ 
                        ...
                        data: [30, 10, 50, 20, 90, 65] // Datos numericos de la grafica
                       }, {
                           fillColor: "rgba(252,147,65,0.5)",
                           strokeColor: "rgba(255,255,255,1)",
                           pointColor: "rgba(173,173,173,1)",
                           pointStrokeColor: "#fff",
                           data: [28, 68, 40, 19, 96, 89]
                       }]
        }
    ...
    var grafica = new Chart(lienzo).Radar(radarChart);
